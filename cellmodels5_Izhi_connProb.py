## cellmodels5_Izhi_connProb.py

# Plots the firing rate of Izhi neurons vs sweep of connection probability
...
pl.title('Parameter sweep of connection probability for Izhi neurons')