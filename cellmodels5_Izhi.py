...
# Population of 80 excitatory and 20 inhibitory Izhi2007b neurons
# Parameters based on cellmodels.py and cellmodels3.py
...
### Saving
simConfig.filename = 'network_model'  # Set file output name
...
simConfig.analysis['plotRatePSD'] = {'include': ['allCells', 'Izhi_E', 'Izhi_I'], 
