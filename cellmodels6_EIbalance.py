...
# Parameter sweep through E vs I balance for both Izhi and HH neurons
...
for neuMod in neuMods:
    ...
    if neuMod == 'Izhi':
        ...
        allFiringRates_Izhi = []
        excCells = [x*5+5 for x in range(20)]
...
import pylab as pl
pl.plot(excCells, allFiringRates_Izhi, label = 'Izhi', linewidth = 3)
pl.plot(excCells, allFiringRates_HH, label = 'HH', linewidth = 3)
pl.xlabel('Number of excitatory cells')
pl.ylabel('Firing rate (Hz)')
pl.title('Firing rate vs balance between E and I cells for Izhi and HH neurons')
pl.legend(loc = 'upper right')
pl.savefig('parasweep_EIbalance.png', dpi=300)