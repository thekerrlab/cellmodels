...
for excCell in excCells:
    ...
    netParams.popParams['E'] = {'cellType': 'E', 'numCells': excCell, 'cellModel': 'Izhi'}
    netParams.popParams['I'] = {'cellType': 'I', 'numCells': 100-excCell, 'cellModel': 'Izhi'}
    ...
    # simConfig.analysis['plotRaster'] = {'orderInverse': False, 'saveFig': 'Izhi_raster.png'} #True # Whether or not to plot a raster
    # simConfig.analysis['plotTraces'] = {'include': [0,80], 'saveFig': 'Izhi_cellTrace.png'}     # plot recorded traces for this list of cells  # changed from cellmodels.py
    # simConfig.analysis['plotRatePSD'] = {'include': ['allCells', 'E', 'I'], 
    # 'smooth': 10, 'saveFig': 'Izhi_PSD.png'} # plot recorded traces for this list of cells
...
pl.title('Firing rate vs balance between E and I cells for Izhi neurons')