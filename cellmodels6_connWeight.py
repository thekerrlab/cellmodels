...
# Parameter sweep through connection weights for both Izhi and HH neurons
...
for neuMod in neuMods:
    ...
    if neuMod == 'Izhi':
        ...
        allFiringRates_Izhi = []
        connWeights = [x*0.05 for x in range(21)]
...
import pylab as pl
pl.plot(connWeights, allFiringRates_Izhi, label = 'Izhi', linewidth = 3)
pl.plot(connWeights, allFiringRates_HH, label = 'HH', linewidth = 3)
pl.xlabel('Connection weight')
pl.ylabel('Firing rate (Hz)')
pl.title('Parameter sweep of connection weight for Izhi and HH neurons')
pl.legend(loc = 'upper right')
pl.savefig('parasweep_connWeight.png', dpi=300)